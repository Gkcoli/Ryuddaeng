public class Final_Exam{
    public static void main(String[] args) throws Exception {
        ...
        for (int row =0; row <15; row++){
            System.out.print("");
            for(int column =0; column <15; column++){
                if(row == 2 && column == 9 || row == 3 && column == 9 || row == 4 && column == 9 || row == 5 && column == 9 || row == 6 && column ==9 || row == 7 && column ==9 || row == 8 && column == 9 || row == 8 && column ==9 || row == 9 && column == 9){
        ...
        for (int row =0; row <15; row++){
            System.out.print("");
            for(int column =0; column <15; column++){
                if(row == 11 && column == 14 || row == 10 && column == 14 || row == 9 && column == 14 || row == 8 && column == 14 || row == 7 && column ==14 || row == 6 && column ==14 || row == 5 && column == 14 || row == 4 && column ==14 || row == 3 && column == 14 || row == 2 && column == 14 || row == 1 && column == 14){
                    System.out.println(array[row][column]);
                }
            }
        }
        ...
        for (int row =0; row <15; row++){
            System.out.println("");
            for(int column =0; column <15; column++){
                if(row == 8 && column == 6 || row == 7 && column == 7 || row == 6 && column == 8 || row == 5 && column == 9 || row == 4 && column == 10 || row ==3 && column == 11 || row ==2 && column ==12 || row == 1 && column == 13 || row == 0 && column ==14 ){
                    System.out.print(array[row][column]);
                }
                else{
                    System.out.print(" ");
